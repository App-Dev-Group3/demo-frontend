...
interface WorkflowContextType {
  ...
  register: (data: { name: string; email: string; password: string; role: string; department?: string }) => boolean;
  logout: () => void;
...
export function WorkflowProvider({ children }: { children: ReactNode }) {
  ...
  const login = (email: string, password: string): boolean => {
    // Mock login logic
    const users = [
      { id: 'user-1', name: 'Juan Dela Cruz', role: 'Admin' as UserRole, email: 'juan@nu.edu.ph', password: 'password123' },
      { id: 'user-2', name: 'Maria Santos', role: 'Requester' as UserRole, email: 'maria@nu.edu.ph', password: 'password123' },
      { id: 'user-3', name: 'Robert Garcia', role: 'Signatory' as UserRole, email: 'robert@nu.edu.ph', password: 'password123' },
      { id: 'user-4', name: 'Anna Reyes', role: 'Signatory' as UserRole, email: 'anna@nu.edu.ph', password: 'password123' },
      { id: 'user-5', name: 'Pedro Rodriguez', role: 'Requester' as UserRole, email: 'pedro@nu.edu.ph', password: 'password123' },
      { id: 'user-6', name: 'Lisa Chen', role: 'Signatory' as UserRole, email: 'lisa@nu.edu.ph', password: 'password123' },
      { id: 'user-7', name: 'Thomas Wilson', role: 'Signatory' as UserRole, email: 'thomas@nu.edu.ph', password: 'password123' },
      { id: 'user-8', name: 'Sarah Johnson', role: 'Signatory' as UserRole, email: 'sarah@nu.edu.ph', password: 'password123' },
    ];
  ...
  const register = (data: { name: string; email: string; password: string; role: string; department?: string }): boolean => {
